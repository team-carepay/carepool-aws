...
public class EC2CredentialsProviderTest {
    ...
    public void setUp() throws IOException {
        ...
        ec2metadata = new EC2MetaData(url -> SECURITY_CREDENTIALS_URL.equals(url.toString()) ? ucRole : ucJson);
        credentialsProvider = new EC2CredentialsProvider(ec2metadata, clock);
    }
    ...
    public void testExpiry() throws IOException {
        ...
        EC2MetaData ec2metadata = new EC2MetaData(url -> SECURITY_CREDENTIALS_URL.equals(url.toString()) ? ucRole : ucJson);
        credentialsProvider = new EC2CredentialsProvider(ec2metadata, clock);
